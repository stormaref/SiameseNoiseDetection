...
class CIFAR10N(NoiseAdder):
    ...
    def __init__(self, dataset: CIFAR10):
        ...
        self.noisy_labels = self.load_label(
            noise_path='data/cifar10n/data.pt', train_labels=dataset.targets, noise_type='aggre_label')
        self.noisy_indices = []
    ...
    def report(self, indices):
        ...
        print(classification_report(real_labels,
              predicted_labels, target_names=labels, digits=4))
    ...
    def load_label(self, noise_path, train_labels, noise_type):
        ...
        if isinstance(noise_label, dict):
            if "clean_label" in noise_label.keys():
                ...
                print(
                    f'The overall noise rate is {1-np.mean(clean_label.numpy() == noise_label[noise_type])}')
